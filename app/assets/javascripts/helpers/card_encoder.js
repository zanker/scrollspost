ScrollsPost.Helpers.cards = {
  ...
  encode: function(cards) {
    ...
    for( var key in cards ) {
      ...
      list.push(ScrollsPost.Helpers.base.convert(cards[key].toString() + key.toString(), this.base_start, this.base77));
    }
  ...
  decode: function(str) {
    ...
    for( var i=0, total=list.length; i < total; i++ ) {
      var val = ScrollsPost.Helpers.base.convert(list[i], this.base77, this.base_start);
