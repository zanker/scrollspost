Capistrano::Configuration.instance(:must_exist).load do
  after "deploy:update" do
    ...
    http.use_ssl = true
    http.request_post("/v1/annotations/deploy.scrollspost", annotation.to_json, {"Content-Type" => "application/json", "Authorization" => "Basic #{Base64.strict_encode64("secret")}"})
  end
end